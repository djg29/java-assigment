...
import com.fulfilment.application.monolith.warehouses.domain.ports.input.LocationResolver;
...
public class LocationGateway implements LocationResolver {
  ...
  public Location resolveByIdentifier(String identifier) {
    var result = locations.stream().filter(location -> location.identification.equals(identifier)).findFirst();
